...
def list_and_create_users():
    ...
    try:
        ...
        base_query = db_session.query(User).filter(User.client == user_client).order_by(User.first_name.asc(), User.last_name.asc())
        ...
        results = base_query.offset((page - 1) * per_page).limit(per_page).all() if total_users else []
...
def update_user(upn):
    ...
    try:
        ...
        user_obj.reporting_manager = request.form.get("reporting_manager", user_obj.reporting_manager)
        user_obj.country = request.form.get("country", user_obj.country)
        user_obj.responsible_country = request.form.get("responsible_country", user_obj.responsible_country)
        user_obj.sales_organization = request.form.get("sales_organization", user_obj.sales_organization)
        ...
        user_obj.sales_territory = request.form.get("sales_territory", user_obj.sales_territory)
        user_obj.teleselling_territory = request.form.get("teleselling_territory", user_obj.teleselling_territory)
        user_obj.bd_territory_name = request.form.get("bd_territory_name", user_obj.bd_territory_name)
        user_obj.ca_territory_name = request.form.get("ca_territory_name", user_obj.ca_territory_name)
        user_obj.mc_territory_name = request.form.get("mc_territory_name", user_obj.mc_territory_name)
        user_obj.p1_territory_name = request.form.get("p1_territory_name", user_obj.p1_territory_name)
        user_obj.p2_territory_name = request.form.get("p2_territory_name", user_obj.p2_territory_name)
        user_obj.p3_territory_name = request.form.get("p3_territory_name", user_obj.p3_territory_name)
        user_obj.p4_territory_name = request.form.get("p4_territory_name", user_obj.p4_territory_name)
        user_obj.p5_territory_name = request.form.get("p5_territory_name", user_obj.p5_territory_name)
        user_obj.ncb_territory_name = request.form.get("ncb_territory_name", user_obj.ncb_territory_name)
        user_obj.preferred_notification_type = request.form.get("preferred_notification_type", user_obj.preferred_notification_type)

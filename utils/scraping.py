...
def logar(username, password):
    ...
    response_post = session.post(
        url, data=payload_login, headers=headers_login, allow_redirects=False
    )
    ...
    # Status 401 = sessão existente, precisa terminar
        ...
        response_terminate = session.post(
            url, data=payload_terminate, headers=headers_ajax
        )
        ...
        if response_terminate.status_code == 200:
            ...
            response_post2 = session.post(
                url, data=payload_login, headers=headers_login, allow_redirects=False
            )
            print(f"Login Status (2a tentativa): {response_post2.status_code}")

            if (
                response_post2.status_code == 302
                or "Location" in response_post2.headers
            ):
                ...
                response_default = session.get(
                    "https://portal.visioniot.net/default.aspx"
                )
                print(f"Default Page Status: {response_default.status_code}")
                return session
        else:
...
def buscar_registros_saude(
    session, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None
):
    """
    ...
    fim = (
        ...
        if end_date is None
        else _ensure_datetime(end_date, "data final")
    )
    inicio = (
        ...
        else _ensure_datetime(start_date, "data inicial")
    )
    if inicio > fim:
    ...
    params_obj = {
        ...
        "cols": json.dumps(
            [
                {
                    "ColumnName": "SmartDeviceHealthRecordId",
                    "Header": "Id",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                ...
                },
                {
                    ...
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                    "Convert": False,
                },
                {
                    "ColumnName": "EvaporatorTemperature",
                    "Header": "Evaporator Temperature(°C)",
                    "Width": 110,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "CondensorTemperature",
                    "Header": "Condensor Temperature(°C)",
                    "Width": 110,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "EvaporatorTemperatureInF",
                    "Header": "Evaporator Temperature(°F)",
                    "Width": 110,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "CondensorTemperatureInF",
                    "Header": "Condensor Temperature(°F)",
                    "Width": 110,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "CoolerVoltage",
                    "Header": "Cooler Voltage(V)",
                    "Width": 100,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "MinVoltage",
                    "Header": "Min Voltage(V)",
                    "Width": 100,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "AvgPowerConsumption",
                    "Header": "Avg Power Consumption(Watt)",
                    "Width": 125,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "TotalCompressorONTime",
                    "Header": "Total compressor ON Time(%)",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "MaxCabinetTemperature",
                    "Header": "Max Cabinet Temperature(°C)",
                    "Width": 100,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "MinCabinetTemperature",
                    "Header": "Min Cabinet Temperature(°C)",
                    "Width": 100,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "MaxCabinetTemperatureInF",
                    "Header": "Max Cabinet Temperature(°F)",
                    "Width": 100,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "MinCabinetTemperatureInF",
                    "Header": "Min Cabinet Temperature(°F)",
                    "Width": 100,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":2}',
                ...
                {
                    "ColumnName": "AmbientTemperatureInF",
                ...
                },
                {
                    ...
                    "Header": "Event Time",
                    "Width": 180,
                    "RendererInfo": "TimeZoneRenderer",
                    "Convert": False,
                },
                {
                    "ColumnName": "GatewayMacAddress",
                    "Header": "Gateway Mac",
                    "Width": 110,
                    "Convert": False,
                },
                {
                    "ColumnName": "GatewaySerialNumber",
                    "Header": "Gateway#",
                    "Width": 110,
                    "Convert": False,
                },
                ...
                {
                    "ColumnName": "SmartDeviceWeekDay",
                    "Header": "Day of Week",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "SmartDeviceWeek",
                    "Header": "Week of Year",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                ...
                {
                    "ColumnName": "TechnicalIdentificationNumber",
                    "Header": "Technical Id",
                    "Width": 150,
                    "Convert": False,
                },
                ...
                {
                    "ColumnName": "SmartDeviceTypeName",
        ...
        "selectedFields": json.dumps(
            [
                "SmartDeviceHealthRecordId as [Id]",
                "EventTypeId as [Event Type]",
                "LightIntensity as [Light]",
                "LightStatus as [Light Status]",
                "Temperature as [Temperature(°C)]",
                "EvaporatorTemperature as [Evaporator Temperature(°C)]",
                "CondensorTemperature as [Condensor Temperature(°C)]",
                "TemperatureInF as [Temperature(°F)]",
                "EvaporatorTemperatureInF as [Evaporator Temperature(°F)]",
                "CondensorTemperatureInF as [Condensor Temperature(°F)]",
                "BatteryLevel as [Battery]",
                "BatteryStatus as [Battery Status]",
                "HealthInterval as [Interval(Min)]",
                "CoolerVoltage as [Cooler Voltage(V)]",
                "MaxVoltage as [Max Voltage(V)]",
                "MinVoltage as [Min Voltage(V)]",
                "AvgPowerConsumption as [Avg Power Consumption(Watt)]",
                "TotalCompressorONTime as [Total compressor ON Time(%)]",
                "MaxCabinetTemperature as [Max Cabinet Temperature(°C)]",
                "MinCabinetTemperature as [Min Cabinet Temperature(°C)]",
                "AmbientTemperature as [Ambient Temperature(°C)]",
                "MaxCabinetTemperatureInF as [Max Cabinet Temperature(°F)]",
                "MinCabinetTemperatureInF as [Min Cabinet Temperature(°F)]",
                "AmbientTemperatureInF as [Ambient Temperature(°F)]",
                "AppName as [App Name]",
                "AppVersion as [App Version]",
                "SDKVersion as [SDK Version]",
                "UploadedByUser as [Data Uploaded By]",
                "AssetCategory as [Asset Category]",
                "EventId as [Event Id]",
                "CreatedOn as [Created On]",
                "EventTime as [Event Time]",
                "GatewayMacAddress as [Gateway Mac]",
                "GatewaySerialNumber as [Gateway#]",
                "AssetTypeId as [Asset Type]",
                "SmartDeviceMonth as [Month]",
                "SmartDeviceDay as [Day ]",
                "SmartDeviceWeekDay as [Day of Week]",
                "SmartDeviceWeek as [Week of Year]",
                "AssetSerialNumber as [Asset Serial #]",
                "TechnicalIdentificationNumber as [Technical Id]",
                "EquipmentNumber as [Equipment Number]",
                "MacAddress as [Smart Device Mac]",
                "SerialNumber as [Smart Device#]",
                "IsSmart as [Is Smart?]",
                "SmartDeviceTypeId as [Smart Device Type]",
                "Location as [Outlet]",
                "LocationCode as [Outlet Code]",
                "OutletType as [Outlet Type]",
                "TimeZoneId as [Time Zone]",
                "ClientName as [Client]",
                "SubClientName as [Sub Client]",
            ]
        ),
...
def buscar_registros_movimento(
    session, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None
):
    """
    ...
    params_obj = {
        ...
        "cols": json.dumps(
            [
                {
                    "ColumnName": "SmartDeviceMovementId",
                    "Header": "Id",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                ...
                {
                    "ColumnName": "MovementCount",
                    "Header": "Movement Count",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "IsDoorOpen",
                    "Header": "Door Open",
                    "Width": 70,
                    "Renderer": "Boolean",
                    "Convert": False,
        ...
        "selectedFields": json.dumps(
            [
                "SmartDeviceMovementId as [Id]",
                "MovementType as [Movement Type]",
                "StartTime as [Start Time]",
                "EventTime as [End Time]",
                "MovementDuration as [Duration]",
                "Latitude as [Latitude]",
                "Longitude as [Longitude]",
                "MovementCount as [Movement Count]",
                "IsDoorOpen as [Door Open]",
                "Displacement as [Displacement(Meter)]",
                "Accuracy as [Accuracy(Meter)]",
                "PowerStatusText as [Power Status]",
                "AppName as [App Name]",
                "AppVersion as [App Version]",
                "SDKVersion as [SDK Version]",
                "UploadedByUser as [Data Uploaded By]",
                "GPSSource as [GPS Source]",
                "EventId as [Event Id]",
                "CreatedOn as [Created On]",
                "GatewayMacAddress as [Gateway Mac]",
                "GatewaySerialNumber as [Gateway#]",
...
def buscar_outlets(session):
    ...
    params_obj = {
        ...
        "comboTypes": json.dumps(
            [
                {"type": "Zone", "loaded": False},
                {"type": "Market", "loaded": False},
                {"type": "PriceType", "loaded": False},
                {"type": "OutletType", "loaded": False},
                {"type": "Country", "loaded": False},
                {"type": "Client", "loaded": False},
            ]
        ),
        "sort": "LocationId",
        "dir": "DESC",
        "cols": json.dumps(
            [
                ...
                {
                    "ColumnName": "IsKeyLocation",
                    "Header": "Is Key Outlet?",
                    "Width": 120,
                    "Renderer": "Boolean",
                    "Convert": False,
                },
                {
                    "ColumnName": "IsSmartStatus",
                    "Header": "Is Smart?",
                    "Width": 100,
                    "Renderer": "Boolean",
                    "Convert": False,
                ...
                {
                    "ColumnName": "PrimarySalesRep",
                    "Header": "Primary Sales Rep",
                    "Width": 120,
                    "Convert": False,
                },
                {
                    "ColumnName": "LocationSalesRep",
                ...
                },
                {
                    ...
                    "Header": "Trade Channel",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "TradeGroup",
                    "Header": "Trade Group",
                    "Width": 120,
                    "Convert": False,
                },
                {
                    "ColumnName": "TradeGroupCode",
                    "Header": "Trade Group Code",
                    "Width": 120,
                    "Convert": False,
                },
                {
                ...
                {
                    "ColumnName": "SubTradeChannelName",
                    "Header": "Sub Trade Channel",
                    "Width": 120,
                    "Convert": False,
                },
                {
                    "ColumnName": "SalesOrganizationName",
                    "Header": "Sales Organization",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "SalesOfficeName",
                    "Header": "Sales Office",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "SalesGroupName",
                    "Header": "Sales Group",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "SalesTerritoryName",
                    "Header": "Sales Territory",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "TeleSellingTerritoryName",
                    "Header": "TeleSelling Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "BD_TerritoryName",
                    "Header": "Business Developer Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "CA_TerritoryName",
                    "Header": "Credit Approver Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "MC_TerritoryName",
                    "Header": "Merchandizer Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P1_TerritoryName",
                    "Header": "P1_Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P2_TerritoryName",
                    "Header": "P2_Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P3_TerritoryName",
                    "Header": "P3_Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P4_TerritoryName",
                    "Header": "P4_Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P5_TerritoryName",
                    "Header": "P5_Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "NCB_TerritoryName",
                    "Header": "Reserve Route Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "RDCustomerName",
                    "Header": "RDCustomer Name",
                    "Width": 120,
                    "Convert": False,
                },
                {
                ...
                {
                    "ColumnName": "Assortment1",
                    "Header": "Assortment 1",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "Assortment2",
                    "Header": "Assortment 2",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "Assortment3",
                    "Header": "Assortment 3",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "Assortment4",
                    "Header": "Assortment 4",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "Assortment5",
                    "Header": "Assortment 5",
                    "Width": 100,
                    "Convert": False,
                },
                ...
                {
                    "ColumnName": "LocationLocalCluster",
                    "Header": "Local Cluster",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "LocationLocalTradeChannel",
                    "Header": "Local TradeChannel",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "LocationChain",
                    "Header": "Chain",
                    "Width": 100,
                    "Convert": False,
                },
                ...
                {
                    "ColumnName": "Capacity",
                    "Header": "Combined Asset Capacity",
                    "Width": 180,
                    "Align": "right",
                    "Renderer": "Float",
                    "RendererInfo": '{"precision":1}',
                    "Convert": False,
                },
                {
                    "ColumnName": "ASMName",
        ...
        "selectedFields": json.dumps(
            [
                "Name as [Name]",
                "Code as [Code]",
                "OutletTypeId as [Outlet Type]",
                "IsKeyLocation as [Is Key Outlet?]",
                "IsSmartStatus as [Is Smart?]",
                "CountryId as [Country]",
                "State as [State]",
                "City as [City]",
                "Street as [Street]",
                "Street2 as [Address 2]",
                "Street3 as [Address 3]",
                "Address4 as [Address 4]",
                "PostalCode as [Postal Code]",
                "Retailer as [Retailer]",
                "PrimaryPhone as [Primary Phone]",
                "PrimarySalesRep as [Primary Sales Rep]",
                "LocationSalesRep as [Sales Rep Name]",
                "Technician as [Technician]",
                "MarketName as [Market]",
                "SalesTarget as [Sales Target]",
                "ClientId as [Client]",
                "Latitude as [Latitude]",
                "Longitude as [Longitude]",
                "LocationType as [Trade Channel]",
                "TradeGroup as [Trade Group]",
                "TradeGroupCode as [Trade Group Code]",
                "IsActive as [Is Active?]",
                "Classification as [Customer Tier]",
                "SubTradeChannelName as [Sub Trade Channel]",
                "SalesOrganizationName as [Sales Organization]",
                "SalesOfficeName as [Sales Office]",
                "SalesGroupName as [Sales Group]",
                "SalesTerritoryName as [Sales Territory]",
                "TeleSellingTerritoryName as [TeleSelling Territory Name]",
                "BD_TerritoryName as [Business Developer Territory Name]",
                "CA_TerritoryName as [Credit Approver Territory Name]",
                "MC_TerritoryName as [Merchandizer Territory Name]",
                "P1_TerritoryName as [P1_Territory Name]",
                "P2_TerritoryName as [P2_Territory Name]",
                "P3_TerritoryName as [P3_Territory Name]",
                "P4_TerritoryName as [P4_Territory Name]",
                "P5_TerritoryName as [P5_Territory Name]",
                "NCB_TerritoryName as [Reserve Route Name]",
                "RDCustomerId as [RDCustomer Name]",
                "TimeZone as [TimeZone]",
                "SubClientName as [Sub Client]",
                "LocationCluster as [Cluster]",
                "MarketSegment as [Market Segment]",
                "Segment as [Segment]",
                "Environment as [Environment]",
                "Assortment1 as [Assortment 1]",
                "Assortment2 as [Assortment 2]",
                "Assortment3 as [Assortment 3]",
                "Assortment4 as [Assortment 4]",
                "Assortment5 as [Assortment 5]",
                "Barcode as [BarCode]",
                "LocationLocalCluster as [Local Cluster]",
                "LocationLocalTradeChannel as [Local TradeChannel]",
                "LocationChain as [Chain]",
                "RegionName as [Region Name]",
                "PrimaryMobile as [Mobile Phone]",
                "PrimaryEmail as [Email]",
                "CPLName as [CPL Name]",
                "ExtraFieldJson as [Extra Field]",
                "CreatedOn as [Created On]",
                "CreatedByUser as [Created By]",
                "ModifiedOn as [Modified On]",
                "ModifiedByUser as [Modified By]",
                "BDAA as [BDAA]",
                "CMMINDCode as [CMMIND]",
                "Capacity as [Combined Asset Capacity]",
                "ASMName as [ASM Name]",
                "ASMEmail as [ASM Email]",
                "TSMName as [TSM Name]",
                "TSMEmail as [TSM Email]",
            ]
        ),
        "selectedConcatenatedFields": json.dumps([]),
        "Title": "Outlet",
...
def buscar_assets(session):
    ...
    params_obj = {
        ...
        "comboTypes": json.dumps(
            [
                {"type": "AssetType", "loaded": False},
                {"type": "State", "loaded": False},
                {"type": "Country", "loaded": False},
                {"type": "AssetCategory", "loaded": False},
                {"type": "SmartDeviceType", "loaded": False},
                {"type": "OutletType", "loaded": False},
                {"type": "Client", "loaded": False},
                {"type": "SubClient", "loaded": False},
                {"type": "TransactionProtocol", "loaded": False},
            ]
        ),
        "cols": json.dumps(
            [
                ...
                {
                    "ColumnName": "EquipmentNumber",
                    "Header": "Bottler Equipment Number",
                    "Width": 150,
                    "Convert": False,
                },
                {
                ...
                {"ColumnName": "City", "Header": "City", "Width": 80, "Convert": False},
                {
                    "ColumnName": "State",
                    "Header": "State",
                    "Width": 50,
        ...
        "selectedFields": json.dumps(
            [
                "AssetTypeId as [Asset Type]",
                "EquipmentNumber as [Bottler Equipment Number]",
                "Location as [Outlet]",
                "LocationCode as [Outlet Code]",
                "OutletTypeId as [Outlet Type]",
                "IsSmart as [Is Smart?]",
                "IsMissing as [Is Missing?]",
                "Latitude as [Latitude]",
                "Longitude as [Longitude]",
                "ClientId as [Client]",
                "City as [City]",
...
def buscar_smart_devices(session):
    ...
    params_obj = {
        ...
        "comboTypes": json.dumps(
            [
                {"type": "SmartDeviceTypeCommand", "loaded": False},
                {"type": "SmartDeviceTag", "loaded": False},
                {"type": "AlertRecipientType", "loaded": False},
                {"type": "SmartDeviceStatus", "loaded": False},
                {"type": "Client", "loaded": False},
                {"type": "SmartDeviceTypeCommandUnique", "loaded": False},
                {"type": "TimeZone", "loaded": False},
                {"type": "SmartDeviceType", "loaded": False},
                {"type": "AssetType", "loaded": False},
                {"type": "Country", "loaded": False},
                {"type": "ShippedCountry", "loaded": False},
                {"type": "SubClient", "loaded": False},
                {"type": "UniqueSmartDeviceTypeCommand", "loaded": False},
                {"type": "DisassociationReason", "loaded": False},
            ]
        ),
        "cols": json.dumps(
            [
                {
                    "ColumnName": "SmartDeviceType",
                    "Header": "Device Type",
                    "Width": 130,
                    "RendererInfo": "",
                    "Convert": False,
                ...
                {
                    "ColumnName": "Asset",
                    "Header": "Linked with Asset",
                    "Width": 100,
                    "RendererInfo": "",
                    "Convert": False,
                },
                {
                    "ColumnName": "AssociationStatus",
                    "Header": "Association",
                    "Width": 60,
                    "Convert": False,
                },
        ...
        "selectedFields": json.dumps(
            [
                "SmartDeviceTypeId as [Device Type]",
                "ManufacturerName as [Manufacturer]",
                "SerialNumber as [Serial Number]",
                "MacAddress as [Mac Address]",
                "Imei as [IMEI]",
                "LastPing as [Last Ping]",
                "Asset as [Linked with Asset]",
                "AssociationStatus as [Association]",
                "IsMissing as [Is Missing?]",
                "LocationName as [Outlet]",
                "LocationCode as [Outlet Code]",
                "OutletType as [Outlet Type]",
                "Street as [Street]",
                "City as [City]",
    ...
    params_obj = {
        ...
        "cols": json.dumps(
            [
                ...
                {
                    "ColumnName": "AlertText",
                    "Header": "Alert Text",
                    "Width": 200,
                    "Convert": False,
                },
                {
                    "ColumnName": "AlertDefinition",
                    "Header": "Alert Definition",
                    "Width": 100,
                    "Convert": False,
                },
                {
                ...
                {
                    "ColumnName": "SmartDeviceSerial",
                    "Header": "Smart Device Serial#",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "AssetEquipmentNumber",
                    "Header": "Asset Equipment Number",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "TechnicalIdentificationNumber",
                    "Header": "Asset Technical Identification Number",
                    "Width": 150,
                    "Convert": False,
                },
                {
                ...
                {
                    "ColumnName": "AlertAgeMins",
                    "Header": "Alert Age(in minutes)",
                    "Width": 130,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "AlertValue",
                    "Header": "Value",
                    "Width": 60,
                    "Align": "right",
                    "Convert": False,
                ...
                {
                    "ColumnName": "AlertWeekDay",
                    "Header": "Day of Week",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "AlertWeek",
                    "Header": "Week of Year",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                ...
                {
                    "ColumnName": "IsSystemAlert",
                    "Header": "Is System Alert?",
                    "Width": 100,
                    "Renderer": "Boolean",
                    "Convert": False,
                },
                {
                    "ColumnName": "AcknowledgeComment",
                    "Header": "Acknowledge Comment",
                    "Width": 230,
                    "RendererInfo": "",
                    "Convert": False,
                },
        ...
        "selectedFields": json.dumps(
            [
                "AlertId as [Id]",
                "AlertTypeId as [Alert Type]",
                "AlertText as [Alert Text]",
                "AlertDefinition as [Alert Definition]",
                "StatusId as [Status]",
                "VisitCheckId as [Visit Check]",
                "AssetSerialNumber as [Asset Serial#]",
                "SmartDeviceSerial as [Smart Device Serial#]",
                "AssetEquipmentNumber as [Asset Equipment Number]",
                "TechnicalIdentificationNumber as [Asset Technical Identification Number]",
                ...
                "IsSmart as [Is Smart?]",
                "AlertAt as [Alert At]",
                "ClosedOn as [Status Changed On]",
                "Priority as [Priority]",
                "AlertRaisedOn as [Age]",
                "AlertAgeMins as [Alert Age(in minutes)]",
                "AlertValue as [Value]",
                "LastUpdatedOn as [Last Update]",
                "Location as [Outlet]",
                "LocationCode as [Outlet Code]",
                "OutletType as [Outlet Type]",
                "City as [Outlet City]",
                ...
                "AlertMonth as [Month]",
                "AlertDay as [Day ]",
                "AlertWeekDay as [Day of Week]",
                "AlertWeek as [Week of Year]",
                "MarketName as [Market]",
                "LocationType as [Trade Channel]",
                "Classification as [Customer Tier]",
                "SalesOrganizationName as [Sales Organization]",
                ...
                "IsSystemAlert as [Is System Alert?]",
                "AcknowledgeComment as [Acknowledge Comment]",
                "CreatedOn as [Created On]",
            ]
        ),
        "selectedConcatenatedFields": json.dumps([]),
...
def buscar_door_statuses(
    ...
    params_obj = {
        ...
        "cols": json.dumps(
            [
                {
                    "ColumnName": "SmartDeviceDoorStatusId",
                    "Header": "Id",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                ...
                {
                    "ColumnName": "DoorOpenDuration",
                    "Header": "Door Open Duration(sec)",
                    "Width": 90,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "SmartDeviceTimeOfDay",
                    "Header": "Time of Day",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "SmartDeviceWeekend",
                    "Header": "Weekday / Weekend",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "HourInDay",
                    "Header": "Hour in Day",
                    "Width": 100,
                    "Align": "right",
                    "Convert": False,
                ...
                {
                    "ColumnName": "VisionErrorCodesInfo",
                ...
                {
                    "ColumnName": "DoorOpenTarget",
                    "Header": "Door Open Target",
                    "Width": 150,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "DoorOpenTemperature",
                    "Header": "Door Open Temperature",
                    "Width": 150,
                    "Align": "right",
                    "Convert": False,
                },
                {
                    "ColumnName": "DoorCloseTemperature",
                    "Header": "Door Close Temperature",
                    "Width": 150,
                    "Align": "right",
                    "Convert": False,
                },
        ...
        "selectedFields": json.dumps(
            [
                "SmartDeviceDoorStatusId as [Id]",
                "DoorOpen as [Open Event Time]",
                "EventTime as [Close Event Time]",
                "EventType as [Event Type]",
                "DoorOpenDuration as [Door Open Duration(sec)]",
                "SmartDeviceTimeOfDay as [Time of Day]",
                "SmartDeviceWeekend as [Weekday / Weekend]",
                "HourInDay as [Hour in Day]",
                "DoorCount as [Door Count]",
                "VisionErrorCodesInfo as [Additional Info]",
                "SalesTerritoryName as [Outlet Territory]",
                "DoorName as [Door]",
                "AssetTypeCapacity as [Capacity Type]",
                "DoorOpenTarget as [Door Open Target]",
                "DoorOpenTemperature as [Door Open Temperature]",
                "DoorCloseTemperature as [Door Close Temperature]",
                "AppName as [App Name]",
                "AppVersion as [App Version]",
                "SDKVersion as [SDK Version]",
                "UploadedByUser as [Data Uploaded By]",
    ...
    params_obj = {
        ...
        "cols": json.dumps(
            [
                ...
                {"ColumnName": "UPN", "Header": "UPN", "Width": 100, "Convert": False},
                {
                    "ColumnName": "PrimaryEmail",
                    "Header": "Email",
                    "Width": 150,
                ...
                {
                    "ColumnName": "ReportingManager",
                    "Header": "Reporting Manager",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "PreferedNotificationType",
                    "Header": "Preferred Notification Type",
                    "Width": 100,
                    "Convert": False,
                },
                {
                ...
                {
                    "ColumnName": "ResponsibleCountry",
                    "Header": "Responsible Country",
                    "Width": 100,
                    "Convert": False,
                },
                {
                ...
                {
                    "ColumnName": "TeleSellingTerritoryName",
                    "Header": "Teleselling Territory",
                    "Width": 100,
                    "Convert": False,
                },
                {
                    "ColumnName": "BD_Territory",
                    "Header": "BD Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "CA_Territory",
                    "Header": "CA Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "MC_Territory",
                    "Header": "MC Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P1_Territory",
                    "Header": "P1 Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P2_Territory",
                    "Header": "P2 Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P3_Territory",
                    "Header": "P3 Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P4_Territory",
                    "Header": "P4 Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "P5_Territory",
                    "Header": "P5 Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "NCB_Territory",
                    "Header": "NCB Territory Name",
                    "Width": 150,
                    "Convert": False,
                },
                {
                    "ColumnName": "LastLoginOn",
        ...
        "selectedFields": json.dumps(
            [
                ...
                "Role as [Role]",
                "ReportingManager as [Reporting Manager]",
                "PreferedNotificationType as [Preferred Notification Type]",
                "Country as [Country]",
                "ResponsibleCountry as [Responsible Country]",
                "IsActive as [Is Active?]",
                "SalesOrganization as [Sales Organization]",
                "SalesOffice as [Sales Office]",
                "SalesGroup as [Sales Group]",
                "SalesTerritory as [Sales Territory]",
                "TeleSellingTerritoryName as [Teleselling Territory]",
                "BD_Territory as [BD Territory Name]",
                "CA_Territory as [CA Territory Name]",
                "MC_Territory as [MC Territory Name]",
                "P1_Territory as [P1 Territory Name]",
                "P2_Territory as [P2 Territory Name]",
                "P3_Territory as [P3 Territory Name]",
                "P4_Territory as [P4 Territory Name]",
                "P5_Territory as [P5 Territory Name]",
                "NCB_Territory as [NCB Territory Name]",
                "LastLoginOn as [Last Login On]",
                "ClientName as [Client]",
                "CreatedOn as [Created On]",
                "CreatedByUser as [Created By]",
                "ModifiedOn as [Modified On]",
                "ModifiedByUser as [Modified By]",
                "RewardPoint as [Reward Point]",
            ]
        ),
        "selectedConcatenatedFields": json.dumps([]),
        "Title": "Users",
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                if data.get("success") == False and "Login failed" in data.get(
                    "message", ""
                ):
...
def buscar_contas_vision():
    ...
    try:
        ...
        # Buscar contas ATIVAS (should_import = True) e clientes separadamente, depois fazer o match manual
        contas = (
            session.query(VisionAccount)
            .filter(VisionAccount.should_import == True)
            .all()
        )

        if not contas:
            print("Nenhuma conta VisionAccount ativa encontrada.")
            return []
        ...
        for conta in contas:
            ...
            if not client:
                ...
                client = (
                    ...
                    .filter(Client.client_code == conta.client_id)
                    .first()
                )
...
def processar_cliente_dados_estaticos(username, password, client_name):
    ...
    print(f"\n{'='*80}")
    print(
        f"PROCESSANDO CLIENTE (DADOS ESTÁTICOS): {client_name} (Username: {username})"
    )
    print(f"{'='*80}")
    ...
    try:
        ...
        print(
            f"ERRO durante o processamento de dados estáticos para {client_name}: {str(e)}"
        )
        import traceback
...
def processar_cliente_dados_diarios(
    username, password, client_name, start_date=None, end_date=None
):
    """
    ...
    try:
        ...
        print(
            f"ERRO durante o processamento de dados diários para {client_name}: {str(e)}"
        )
        import traceback
    ...
    if sucessos == total:
        ...
        try:
            ...
            result = subprocess.run(
                [sys.executable, "import_all_data.py"],
                capture_output=True,
                text=True,
